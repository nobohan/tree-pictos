    ...
    for c in CENTRE:
        for d in DOTS[1:4]:
            dwg = draw_broadleaved_symbol(
                dwg, ORIGINS[ii], n, "circular", 0, d, c, True
            )
            ii = ii + 1
...
for n in (3, 4, 5):
    ...
    dwg = draw_broadleaved_symbol(
        dwg, (X[0], Y[n - 1]), n, "convex", convexity, None, None, True
    )
    dwg = draw_broadleaved_symbol(
        dwg, (X[4], Y[n - 1]), n, "convex", convexity, None, "p", True
    )
    dwg = draw_broadleaved_symbol(
        dwg, (X[8], Y[n - 1]), n, "convex", convexity, None, "o", True
    )
    ii = 0
    ORIGINS = (
        (X[1], Y[n - 1]),
    ...
    for c in CENTRE:
        for d in DOTS[1:4]:
            dwg = draw_broadleaved_symbol(
                dwg, ORIGINS[ii], n, "convex", convexity, d, c, True
            )
            ii = ii + 1
...
for n in (3, 4, 5):
    dwg = draw_broadleaved_symbol(
        dwg, (X[0], Y[n + 2]), n, "concave", concavity, None, None, True
    )
    dwg = draw_broadleaved_symbol(
        dwg, (X[4], Y[n + 2]), n, "concave", concavity, None, "p", True
    )
    dwg = draw_broadleaved_symbol(
        dwg, (X[8], Y[n + 2]), n, "concave", concavity, None, "o", True
    )
    ii = 0
    ORIGINS = (
        (X[1], Y[n + 2]),
    ...
    for c in CENTRE:
        for d in DOTS[1:4]:
            dwg = draw_broadleaved_symbol(
                dwg, ORIGINS[ii], n, "concave", concavity, d, c, True
            )
            ii = ii + 1
